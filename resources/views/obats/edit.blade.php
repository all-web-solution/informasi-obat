                ...
                <form action="{{ route('obats.update', $obat->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="kekuatan_dosis" class="form-control"
                                value="{{ $obat->kekuatan_dosis }}" required>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="penyimpanan_suhu" class="form-select" required>
                                <option value="rak"
                                    {{ ($obat->informasiObat->penyimpanan_suhu ?? '') == 'rak' ? 'selected' : '' }}>Suhu Rak
                                    (15-30°C)</option>
                                <option value="kulkas"
                                    {{ ($obat->informasiObat->penyimpanan_suhu ?? '') == 'kulkas' ? 'selected' : '' }}>
                                    Kulkas (2-8°C)</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-check">
                                <input type="checkbox" name="hindari_cahaya" value="1" class="form-check-input"
                                    id="hindariCahaya"
                                    {{ $obat->informasiObat->hindari_cahaya ?? false ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input type="checkbox" name="hindari_kelembaban" value="1" class="form-check-input"
                                    ...
                                    {{ $obat->informasiObat->hindari_kelembaban ?? false ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-check mb-2">
                                <input type="checkbox" name="tidak_hentikan_mendadak" value="1"
                                    ...
                                    {{ $obat->informasiObat->tidak_hentikan_mendadak ?? false ? 'checked' : '' }}>
                                <label class="form-check-label" for="tidakHentikan">⚠️ Tidak boleh dihentikan
                                    mendadak</label>
                            </div>
                            <div class="form-check mb-2">
                                <input type="checkbox" name="harus_dihabiskan" value="1" class="form-check-input"
                                    id="harusDihabiskan"
                                    {{ $obat->informasiObat->harus_dihabiskan ?? false ? 'checked' : '' }}>
                                <label class="form-check-label" for="harusDihabiskan">✓ Harus dihabiskan sesuai
                                    resep</label>
                            </div>
                        </div>
